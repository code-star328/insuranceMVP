...
const products = [
  ...
  },
  {
    id: 'life',
    name: 'Life Insurance',
    description: 'Ensure your loved ones are financially protected with our life insurance plans.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Get the healthcare coverage you need with our flexible health insurance options.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Protect your business with our tailored insurance solutions for businesses of all sizes.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Travel with peace of mind knowing you're covered with our comprehensive travel insurance.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          {products.map((product) => (
            <div key={product.id} className="card flex flex-col h-full">
              ...
              <div className="p-6 pt-0 mt-auto">
                <Link href={`/chat?product=${product.id}`} className="btn-primary w-full text-center">
                  Learn More
                </Link>
              </div>
            </div>
